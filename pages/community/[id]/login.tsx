...
const LoginPage: NextPage = () => {
    ...
    return (
        <Container maxWidth="lg">
            {!account ? (
                <Grid container spacing={4} justifyContent="space-between">
                    <Grid item xs={12} sm={6}>
                        ...
                        <Box display="flex">
                            <Typography variant="h6" sx={{   fontWeight: 600 }}>Member Directory.</Typography>
                        ...
                        <Grid item xs={12} sm={6}>
                            <Card>
                                ...
                                <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    <Typography variant="body1" color="#F5FFF4" textAlign="center" sx={{ width: '80%', py: 8 , fontWeight : 300 }}>
                                    ...
                                    <Button variant="contained" onClick={() => signIn('discord')} sx={{
                                        mb: { xs: 5, sm :  5,  md: 24 }, background: "#3E41BB", ':hover': {
                                            opacity: .7, background: '#3E41BB' 
                                        } }}>
                                        Login with Discord
                                    </Button>
                                </CardContent>
            ...
            >
                <Box sx={{ background: '#A3ECAA', px: 3, py: 2, borderRadius: '5px', boxShadow: ' 0px 5px 10px rgba(0, 0, 0, 0.12)' }}>
                    <Typography sx={{ color: '#11151F' , fontWeight: 300 }}>
